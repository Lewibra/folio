...
namespace PigWorldNamespace {
    ...
    public class CellView : PictureBox {
        ...
        protected override void OnMouseDown(MouseEventArgs e) {
            ...
            // If it's the left-hand mouse button,
            if (e.Button == MouseButtons.Left) {
                // If the pictureBox doesn't have a LifeFormView, 
                // then add the currently selected type of object.
            ...
            } else {  // Assume it's the right-hand mouse button.
                // Allow the base class to handle the right-hand mouse button, 
                // to display a context menu (if any).
                base.OnMouseMove(e);
            }
        }
