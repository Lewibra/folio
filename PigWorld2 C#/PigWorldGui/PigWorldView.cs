...
namespace PigWorldNamespace {
    ...
    public class PigWorldView : TableLayoutPanel {
        ...
        /// <summary>
        /// Set-up the 3rd demo, by adding various objects (and walls) to PigWorld.
        /// </summary>
        public void SetupDemo3() {

            BoyPig boyPig = new BoyPig(PigWorld, new Position(1, 0));
            GirlPig girlPig = new GirlPig(PigWorld, new Position(6, 5));

            Tree tree1 = new Tree(PigWorld, new Position(8, 1));
            Tree tree2 = new Tree(PigWorld, new Position(0, 5));

            Wolf wolf = new Wolf(PigWorld, new Position(0, 8));

            PigFood pigFood1 = new PigFood(PigWorld, new Position(2, 3));
            PigFood pigFood2 = new PigFood(PigWorld, new Position(5, 2));
            PigFood pigFood3 = new PigFood(PigWorld, new Position(2, 7));

            PigWorld.FillVerticalGap(3, 1);
            PigWorld.FillVerticalGap(4, 1);
            PigWorld.FillVerticalGap(5, 1);
            PigWorld.FillVerticalGap(6, 1);
            PigWorld.FillVerticalGap(7, 1);
            PigWorld.FillVerticalGap(8, 1);
            PigWorld.FillHorizontalGap(2, 2);
            PigWorld.FillHorizontalGap(2, 3);
            PigWorld.FillHorizontalGap(2, 4);

            PigWorld.FillVerticalGap(0, 6);
            PigWorld.FillVerticalGap(1, 6);
            PigWorld.FillVerticalGap(2, 6);
            PigWorld.FillVerticalGap(3, 6);
            PigWorld.FillVerticalGap(4, 6);
            PigWorld.FillVerticalGap(5, 6);
            PigWorld.FillHorizontalGap(5, 6);
            PigWorld.FillHorizontalGap(5, 5);
            PigWorld.FillHorizontalGap(5, 4);
        }
